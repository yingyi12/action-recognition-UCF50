...
class DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        df_train = process_images('/nas/lrz/tuei/ldv/studierende/data/video/i-frame/train-i-frame')
        df_val = process_images('/nas/lrz/tuei/ldv/studierende/data/video/i-frame/val-i-frame')
        df_test = process_images('/nas/lrz/tuei/ldv/studierende/data/video/i-frame/test-i-frame')
...
class LSTMRegressor(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        if self.current_epoch == self.trainer.max_epochs - 1:
            ...
            names = ['YoYo', 'WalkingWithDog', 'VolleyballSpiking', 'TrampolineJumping', 'ThrowDiscus', 'TennisSwing', 'TaiChi', 'Swing', 'SoccerJuggling', 
            ...
            plt.savefig('/nas/lrz/tuei/ldv/studierende/data/video/i-frame-50/42/myfigure.png')
...
csv_logger = CSVLogger('/nas/lrz/tuei/ldv/studierende/data/video', name='i-frame-50', version='42'),
